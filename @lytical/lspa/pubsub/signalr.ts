...
export class spa_pubsub_signalr extends spa_pubsub_svc {
  ...
  connect() {
    ...
    let sock = new signalr.HubConnectionBuilder().withUrl(require.toUrl('sock/info/')).build();
...
export default new spa_pubsub_signalr();